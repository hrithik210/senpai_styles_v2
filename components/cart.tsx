...
const Cart = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center p-4 md:p-8'>
        ...
        {/* Cart Items */}
        {items.map((item) => (
          <div key={item.id} className='relative flex flex-col p-4 md:p-6 bg-[#1a1a1a] rounded-lg border border-[#EA2831]/20 w-full max-w-4xl mt-4 md:mt-8 gap-4'>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-3 md:space-x-4'>
                  ...
                  <div className='min-w-0 flex-1'>
                      ...
                      <p className="text-[#EA2831] text-xs md:text-sm font-medium">Size: {item.size}</p>
                  </div>
              </div>
